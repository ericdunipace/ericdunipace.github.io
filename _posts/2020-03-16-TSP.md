...
See the IBM website for more details: https://www.ibm.com/products/ilog-cplex-optimization-studio
...
The easiest way for me is within the TSP R package. You may need to specify the location of the Concorde TSP files like so:
~~~ r
